          ...
          <div className="bg-white rounded-lg shadow-md p-8 space-y-8">
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">
                1. Independent Verification Service
              </h2>
              <p className="text-gray-600">
                National Mover Bureau is an independent verification service. We
                are not affiliated with, endorsed by, or connected to any
                government agency, including but not limited to the Federal
                Motor Carrier Safety Administration (FMCSA), Department of
                Transportation (DOT), or any state regulatory bodies.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">
                3. Risk Assessment Disclaimer
              </h2>
              <div className="space-y-4 text-gray-600">
                <p>Our risk assessment and scoring system:</p>
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Is not a guarantee of company performance or reliability
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600">
                The information provided through our services does not
                constitute legal advice and should not be relied upon as such.
                Consult with qualified legal professionals for specific advice
            ...
            <section>
              ...
              <p className="text-gray-600">
                Our service includes information from third-party sources. We
                are not responsible for the accuracy, completeness, or
                reliability of third-party content. Links to external websites
            ...
            <section>
              ...
              <p className="text-gray-600">
                The inclusion of any company in our database does not constitute
                an endorsement or recommendation. A favorable rating or review
                does not guarantee satisfactory service or performance.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-600">
                <p>National Mover Bureau shall not be liable for:</p>
                <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <p className="text-gray-600">
                ...
                aspect of our service at any time without notice. We are not
            ...
            <section>
              ...
              <p className="text-gray-600">
                ...
                <a
                  href="mailto:legal@nationalmoverbureau.org"
