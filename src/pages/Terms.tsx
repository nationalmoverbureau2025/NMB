          ...
          <div className="bg-white rounded-lg shadow-md p-8 space-y-8">
            <section>
              ...
              <p className="text-gray-600">
                By accessing or using National Mover Bureau's services, you
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  ...
                  personal, non-commercial use. This license does not include:
                </p>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  We provide moving company verification services and reports.
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Certain services require payment. By purchasing our services,
                  you agree to:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <p>
                  Subscription services will automatically renew unless
                  cancelled. Refunds are subject to our refund policy.
                </p>
              </div>
            </section>
