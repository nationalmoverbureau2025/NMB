        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Understanding the key regulations and requirements for moving
              companies
            </p>
          </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-amber-800 text-sm mt-1">
                This guide provides general information about moving
                regulations. For the most current and detailed requirements,
                always refer to official FMCSA documentation and consult with
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    All interstate moving companies must have a valid USDOT
                    number issued by the Federal Motor Carrier Safety
                    Administration (FMCSA). This unique identifier helps monitor
                    a company's safety information and compliance with federal
                    regulations.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    Required for companies transporting household goods across
                    state lines. The MC number indicates authority to operate as
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <ul className="list-disc pl-6 text-gray-600 space-y-2">
                    <li>
                      Public liability insurance: Minimum $750,000 coverage
                    </li>
                    <li>
                      Cargo insurance: Based on vehicle weight and cargo type
                    </li>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <ul className="list-disc pl-6 text-gray-600 space-y-2">
                    ...
                    <li>
                      Driver qualification files and drug testing programs
                    </li>
            ...
            <section className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <p className="text-gray-600">
                  In addition to federal regulations, moving companies must
                  comply with state-specific requirements, which may include:
                </p>
                <ul className="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <p className="text-gray-600">
                  Requirements vary by state. Contact your state's
                  transportation department for specific requirements.
                </p>
              </div>
            </section>
            ...
            <section className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <p className="text-gray-600">
                  Failure to comply with federal and state regulations can
                  result in:
                </p>
                <ul className="list-disc pl-6 text-gray-600 space-y-2">
            ...
            <div className="bg-blue-900 text-white rounded-lg p-8 text-center">
              ...
              <p className="text-blue-100 mb-6">
                Ensure your moving company complies with all necessary
                regulations. Get a comprehensive verification report today.
              </p>
