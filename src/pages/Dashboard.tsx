      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Welcome back! Here's an overview of your reports and activity.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Find and analyze moving companies in our database.
          </p>
          <Button onClick={() => navigate('/search')}>Start Search</Button>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            You have {userReports?.length || 0} report(s) available.
          </p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Set up notifications for company changes.
          </p>
