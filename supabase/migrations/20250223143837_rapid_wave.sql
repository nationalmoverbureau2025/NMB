/*
  # Consolidate company fields

  1. Changes
    - Add all missing fields to companies table in a single migration
    - Update example company data with complete information
*/

-- Add all missing fields if they don't exist
DO $$ 
BEGIN
  IF NOT EXISTS (
